...
import {
  ...
  ParameterType,
  ParameterMetadata,
} from '@/interfaces/storage/IParameterStore';
...
export class AWSParameterStoreAdapter implements IParameterStore {
  ...
  async storeParameter(
    ...
    await this.ssmService.storeParameter(name, value, description, type);
  }
  ...
  async getParametersByPath(
    ...
    throw new Error(
      'getParametersByPath not yet implemented. Add to SSMParameterService if needed.'
    );
  }
  ...
  async deleteParametersByPath(
    ...
    throw new Error(
      'deleteParametersByPath not yet implemented. Add to SSMParameterService if needed.'
    );
  }
  ...
  async listParameters(
    ...
    throw new Error(
      'listParameters not yet implemented. Add to SSMParameterService if needed.'
    );
  }
