        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Enter the access code to access the feature.
                    </DialogDescription>
                    <Input type="text" placeholder="Enter your access code" value={accessCode} onChange={(e) => setAccessCode(e.target.value)} />
                    <Button onClick={async () => {
                        ...
                        setIsLoading(false)
                    }} disabled={isLoading}>{isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : 'Verify'}</Button>
                </DialogHeader>
            </DialogContent>
        </Dialog>
    )
