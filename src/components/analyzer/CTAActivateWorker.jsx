    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-[#F2EDE7] uppercase text-sm font-bold" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
        ...
        <Link to={createPageUrl("Worker")}>
          <Button
            className="w-full bg-gradient-to-r from-[#FF6B00] to-[#FF223B] hover:shadow-lg hover:shadow-[#FF223B]/50 text-white h-12 group"
