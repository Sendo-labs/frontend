  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-[#F2EDE7]/60 uppercase text-sm" style={{ fontFamily: 'TECHNOS, sans-serif' }}>SHARE YOUR PAIN</h3>
      </div>
      ...
      <div className="space-y-3">
        ...
        <Button
          ...
          className="w-full bg-gradient-to-r from-[#FF6B00] to-[#FF223B] hover:shadow-lg hover:shadow-[#FF223B]/50 text-white h-12"
