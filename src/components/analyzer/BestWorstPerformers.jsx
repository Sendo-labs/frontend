...
export default function BestWorstPerformers({ best, worst }) {
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
      animate={{ opacity: 1, x: 0 }}
      transition={{ delay: 0.4, duration: 0.6 }}
      className="bg-[#0D0D0D] border border-[#F2EDE7]/10 p-6 space-y-6"
    ...
    >
      ...
      <div className="bg-[#14F195]/5 border border-[#14F195]/20 p-4" style={{ borderRadius: 0 }}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-bold text-[#14F195] uppercase" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
            BEST PERFORMER
          </h4>
        </div>
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-[#14F195] font-bold" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
      ...
      <div className="bg-[#FF223B]/5 border border-[#FF223B]/20 p-4" style={{ borderRadius: 0 }}>
        <div className="flex items-center gap-2 mb-3">
          ...
          <h4 className="text-sm font-bold text-[#FF223B] uppercase" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
            WORST PERFORMER
          </h4>
        </div>
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            <span className="text-[#F2EDE7]/60 text-sm">PnL</span>
            <span className="text-[#FF223B] font-bold" style={{ fontFamily: 'TECHNOS, sans-serif' }}>
