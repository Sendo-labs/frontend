		...
		<PageWrapper>
			...
			>
				<div className='bg-foreground/5 border border-foreground/10 p-4 sm:p-6 text-center rounded-none'>
					<div className='text-3xl sm:text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red bg-clip-text text-transparent title-font numeric-font'>
						100%
					</div>
				...
				<div className='space-y-6 md:space-y-8 mt-12'>
					...
					>
						<div className='grid md:grid-cols-[auto_1fr_auto] gap-4 md:gap-6 p-6 md:p-8 items-center'>
							{/* Number Badge */}
							<div
								className='absolute -top-3 -left-3 w-14 h-14 bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red flex items-center justify-center group-hover:scale-110 transition-transform'
							...
							{/* Icon */}
							<div
								className='w-16 h-16 md:w-20 md:h-20 bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red flex items-center justify-center ml-8 md:ml-0'
							...
							>
								<Button
									className='bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red hover:shadow-lg hover:shadow-sendo-red/50 text-white h-12 px-6 group/btn'
									style={{
			...
			<motion.div
				...
				whileInView={{ opacity: 1, y: 0 }}
				transition={{ duration: 0.8 }}
				className='bg-gradient-to-br from-sendo-orange/10 via-sendo-red/10 to-[#450C13]/10 border border-sendo-orange/30 p-8 md:p-12 relative overflow-hidden'
				style={{ borderRadius: 0 }}
			>
				<div className='absolute top-0 right-0 w-64 h-64 bg-sendo-orange/5 blur-3xl' />
				...
				<div className='relative z-10 text-center'>
					...
					<div className='flex flex-col sm:flex-row gap-4 justify-center'>
						<a href='https://github.com/orgs/Sendo-labs/projects/2/views/1' target='_blank' rel='noopener noreferrer'>
							<Button
								className='bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red hover:shadow-lg hover:shadow-sendo-red/50 text-white h-14 px-8 group/btn w-full sm:w-auto rounded-none'
								style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 12px), calc(100% - 12px) 100%, 0 100%)' }}
							>
