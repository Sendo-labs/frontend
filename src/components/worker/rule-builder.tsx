					...
					>
						...
						{expandedRule === rule.id && (
							<div className='px-4 pb-4 border-t border-foreground/10 pt-4'>
								{rule.id === 'sell_dust' && (
									<div>
										<label htmlFor="min-usd-input" className='text-xs text-foreground/60 mb-2 block'>Minimum USD Value</label>
										<Input
											type='number'
								...
								{rule.id === 'take_profit' && (
									<div>
										<label htmlFor="target-profit-percentage-input" className='text-xs text-foreground/60 mb-2 block'>Target Profit Percentage</label>
										<Input
											type='number'
								...
								{rule.id === 'rebalance' && (
									<div className='space-y-3'>
										<div>
											<label htmlFor="sol-target-percentage-input" className='text-xs text-foreground/60 mb-2 block'>SOL Target %</label>
											<Input
												type='number'
										...
										<div>
											<label htmlFor="usdc-target-percentage-input" className='text-xs text-foreground/60 mb-2 block'>USDC Target %</label>
											<Input
												type='number'
