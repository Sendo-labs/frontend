		...
		>
			...
			<div className='p-6'>
				...
				<div className='flex items-start gap-4 mb-4'>
					<div
						className='w-14 h-14 bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red flex items-center justify-center text-3xl flex-shrink-0'
				...
				<div className='grid grid-cols-2 gap-3'>
					...
					<Button
						onClick={onDeploy}
						className='bg-gradient-to-r from-sendo-orange via-sendo-red to-sendo-dark-red hover:shadow-lg hover:shadow-sendo-red/50 text-white h-10 uppercase'
						style={{
