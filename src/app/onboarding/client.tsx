				...
				<div className='space-y-6 md:space-y-8 mt-12'>
					...
					>
						<div className='grid md:grid-cols-[auto_1fr_auto] gap-4 md:gap-6 p-6 md:p-8 items-center'>
							{/* Number Badge */}
							<div
								className='absolute -top-3 -left-3 w-14 h-14 bg-gradient-to-r from-[#FF5C1A] via-[#FF223B] to-[#450C13] flex items-center justify-center group-hover:scale-110 transition-transform'
							...
							{/* Icon */}
							<div
								className='w-16 h-16 md:w-20 md:h-20 bg-gradient-to-r from-[#FF5C1A] to-[#FF223B] flex items-center justify-center ml-8 md:ml-0'
