		...
		<div className='min-h-screen bg-background text-foreground pt-24 pb-12'>
			<div className='max-w-[1400px] mx-auto px-4 sm:px-6 py-12 md:py-20'>
				...
				<motion.div
					...
					whileInView={{ opacity: 1, y: 0 }}
					transition={{ duration: 0.8 }}
					className='bg-gradient-to-r from-[#FF5C1A]/10 via-[#FF223B]/10 to-[#4A0C13]/10 border border-sendo-orange/30 p-12 text-center'
					style={{ borderRadius: 0 }}
				>
					...
					<button
						type='button'
						className='bg-gradient-to-r from-[#FF5C1A] via-[#FF223B] to-[#4A0C13] hover:shadow-lg hover:shadow-sendo-red/50 text-white px-8 py-4 text-lg font-bold transition-all uppercase cursor-pointer'
						style={{
