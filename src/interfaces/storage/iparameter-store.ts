...
export interface IParameterStore {
	 ...
	 */
	storeParameter(name: string, value: string | object, description?: string, type?: ParameterType): Promise<void>;
	 ...
	 */
	getParametersByPath(path: string, recursive?: boolean): Promise<Map<string, string>>;
	 ...
	 */
	getParameterMetadata(parameterName: string): Promise<ParameterMetadata | null>;
