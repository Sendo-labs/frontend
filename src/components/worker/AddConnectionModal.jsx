...
// Import tous les plugins de la marketplace
const MARKETPLACE_PLUGINS = {
  sponsored: [
    {
      ...
      authType: "api_key",
      configFields: [
        { name: "jupiter_api_key", label: "JUPITER API KEY", type: "password", required: true, description: "Your Jupiter API key" },
        { name: "slippage", label: "SLIPPAGE (%)", type: "number", required: true, default: 1 }
      ]
    },
    {
      id: "spartan",
  ...
  liquidity: [
    ...
    },
    {
      ...
      authType: "api_key",
      configFields: [
        { name: "raydium_rpc", label: "RPC ENDPOINT", type: "text", required: true },
        { name: "priority_fee", label: "PRIORITY FEE (SOL)", type: "number", default: 0.0001 }
      ]
    },
    {
      id: "meteora",
      ...
      authType: "api_key",
      configFields: [
        { name: "meteora_api_key", label: "METEORA API KEY", type: "password", required: true }
      ]
    }
  ],
  trading: [
    ...
    },
    {
      ...
      authType: "api_key",
      configFields: [
        { name: "jito_api_key", label: "JITO API KEY", type: "password", required: true }
      ]
    },
    {
      id: "kamino",
      ...
      authType: "api_key",
      configFields: [
        { name: "kamino_api_key", label: "KAMINO API KEY", type: "password", required: true }
      ]
    }
  ],
  ai: [
  ...
  community: [
    {
      ...
      authType: "api_key",
      configFields: [
        { name: "scoring_api_key", label: "SCORING API KEY", type: "password", required: true }
      ]
    },
    {
    ...
    },
    {
      ...
      authType: "api_key",
      configFields: [
        { name: "twitter_api_key", label: "TWITTER API KEY", type: "password", required: true }
      ]
    },
    {
      id: "reputation-index",
      ...
      authType: "api_key",
      configFields: [
        { name: "reputation_api_key", label: "REPUTATION API KEY", type: "password", required: true }
      ]
    }
  ]
};

export default function AddConnectionModal({ onClose, onSelectPlugin }) {
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="grid md:grid-cols-2 gap-4">
              {filteredPlugins.map((plugin) => (
                ...
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-[#FF6B00] to-[#FF223B] flex items-center justify-center text-2xl flex-shrink-0" style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%)' }}>
                    {plugin.icon}
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="px-2 py-0.5 bg-[#F2EDE7]/10 text-[#F2EDE7]/60 text-xs uppercase" style={{ borderRadius: 0 }}>
